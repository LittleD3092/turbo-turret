...
class Metaclass_Controller_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('controller_input')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Controller(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'controller_input.srv.Controller')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from controller_input.srv import _controller
...
class Controller(metaclass=Metaclass_Controller):
    from controller_input.srv._controller import Controller_Request as Request
    from controller_input.srv._controller import Controller_Response as Response
