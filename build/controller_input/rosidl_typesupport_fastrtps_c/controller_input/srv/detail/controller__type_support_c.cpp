...
#include "controller_input/srv/detail/controller__rosidl_typesupport_fastrtps_c.h"
...
#include "controller_input/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Controller_Request__ros_msg_type = controller_input__srv__Controller_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_input
size_t get_serialized_size_controller_input__srv__Controller_Request(
  const void * untyped_ros_message,
...
static uint32_t _Controller_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller_input__srv__Controller_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_input
size_t max_serialized_size_controller_input__srv__Controller_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Controller_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller_input__srv__Controller_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_input, srv, Controller_Request)() {
...
using _Controller_Response__ros_msg_type = controller_input__srv__Controller_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_input
size_t get_serialized_size_controller_input__srv__Controller_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Controller_Response__ros_msg_type * ros_message = static_cast<const _Controller_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_controller_input__srv__Controller_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_input
size_t max_serialized_size_controller_input__srv__Controller_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Controller_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_controller_input__srv__Controller_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_input, srv, Controller_Response)() {
...
// already included above
// #include "controller_input/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "controller_input/srv/controller.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_input, srv, Controller)() {
