...
#include "controller_input_srv/srv/detail/controller__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const controller_input_srv::srv::Controller_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<controller_input_srv::srv::Controller_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_controller_input_srv
const rosidl_message_type_support_t *
get_message_type_support_handle<controller_input_srv::srv::Controller_Request>()
{
  return &controller_input_srv::srv::typesupport_fastrtps_cpp::_Controller_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const controller_input_srv::srv::Controller_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<controller_input_srv::srv::Controller_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &controller_input_srv::srv::typesupport_fastrtps_cpp::_Controller_Response__handle;
}
...
{
  return &controller_input_srv::srv::typesupport_fastrtps_cpp::_Controller__handle;
}
